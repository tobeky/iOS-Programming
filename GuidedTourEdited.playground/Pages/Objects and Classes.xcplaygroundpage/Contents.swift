...
//:
//: **Justin Note:** Methods follow similar conventions to functions.  Method names should follow the convention of referring to the first parameter, which is a standard Apple convention.  Please see my added method for an example:
//:
class Square: NamedShape {
    ...
    //Justin's new method here:
    func scaleBy(scaleAmount: Double) {
        sideLength = sideLength * scaleAmount
    }
